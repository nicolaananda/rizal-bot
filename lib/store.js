...
const expiredCheck = (arap, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            arap.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( async res => {
              await arap.groupLeave(_dir[position].id)
